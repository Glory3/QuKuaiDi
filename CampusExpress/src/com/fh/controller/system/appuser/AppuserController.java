...
import com.fh.util.json.JackJsonUtils;
import com.fh.util.json.ResponseUtils;
import com.fh.util.json.SingleObject;
import com.fh.util.json.StatusCode;
...
public class AppuserController extends BaseController {
	...
	@RequestMapping(value="/qdLogin")
	   public @ResponseBody SingleObject getUser(@PathVariable String code) {

		SingleObject result = new SingleObject();
		result.setCode(StatusCode.success);
		result.setMsg("访问成功");
		result.setObject("code is " + code);
	      return result;
	   }
